...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Answer'
        db.create_table('collection_answer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collection.Team'])),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collection.Question'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('correct', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('points', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('early_finish', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('collection', ['Answer'])

        # Deleting field 'Question.answer'
        db.delete_column('collection_question', 'answer')

        # Adding field 'Question.correct_answer'
        db.add_column('collection_question', 'correct_answer', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Answer'
        db.delete_table('collection_answer')

        # Adding field 'Question.answer'
        db.add_column('collection_question', 'answer', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Deleting field 'Question.correct_answer'
        db.delete_column('collection_question', 'correct_answer')
